                ...
                <div className="grid grid-cols-3 lg:ml-40 lg:mt-8">
                    {
                        jobdata && jobdata.map((val:jobdata) => {
                            return (<>
                                <div className="p-6 m-2 flex-col  space-y-3 sm:w-40 lg:w-[500px] h-96 rounded-md border shadow-xl  ">
