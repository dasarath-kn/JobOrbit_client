...
const Footer = () => {
  ...
  return (
    ...
    <div className='mb:8 md:mb:0 mt-5 pl-3'>
        <span className='self-center sm:mt-9  text-2xl font-semibold whitespace-nowrap dark:text-white'>JobOrbit</span>
        <div >
    ...
    <div className='text-white font-light md:pt-20 pt-2 items-start  pl-4 '>
       <ul className=' md:space-y-4 cursor-pointer '>
