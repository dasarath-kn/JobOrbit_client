      ...
      <div className="max-w-screen-xl flex flex-wrap  justify-between  lg:mx-36 p-8">
        ...
        <div className={`${isOpen ? 'block' : 'hidden'}    w-full md:block md:w-auto`} id="navbar-default">
          <ul className="font-medium  flex flex-col p-4   md:p-0 mt-4 border  md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 ">
            ...
            <li>
              <a href="/job" className="block py-2 px-3 text-whi rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-gray-400 md:p-0 dark:text-white md:dark:hover:text-white-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Find JOb    </a>
            </li>
            <li>
              <a href="#" className="block py-2 px-3 text-whi rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-gray-400 md:p-0 dark:text-white md:dark:hover:text-white-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Dashboard    </a>
            </li>
            <li>
            ...
            <li className=''>
              {
                userDatas.img_url ? <img src={userDatas.img_url} className='rounded-lg  w-14 ' alt="" />:
