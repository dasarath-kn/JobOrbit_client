...
import HalfCircleGraph from './HalfCircleGraph'
...
const Profile = () => {
  ...
  const handleExperience = async () => {
    const experienceData = { experiencefield: experiencefield, duration: duration, responsibilities: responsibilities, percentage: data?.percentage }
  ...
  return (
    <>
      ...
      {load == false &&
        <div className='w-full h-auto flex sm:justify-center sm:w-full flex-col    items-center  '>

          <div className='shadow-2xl rounded-3xl  text-white flex flex-row sm:w-full lg:w-4/5 1/2 h-auto mt-20   '>
            <div className='lg:w-1/4 h-auto  lg:content-center sm:w-1/2 sm:h-1/2  md:content-center  mt-20'>

              {data?.img_url ? (
                <img src={data?.img_url} className='ml-4 mt-4 rounded-3xl ' alt="Default Image" />
              ) : (<>
            ...
            <div className='rounded-2xl flex flex-col  w-3/4 m-9 h-auto shadow-xl p-6 bg-white'>
                  ...
                  <div className='flex flex-col space-y-2 '>
                    ...
                    <div>
                      <button
                        ...
                        className='bg-black text-white w-16 h-9'
                      >
                        Add
                      </button>                    </div>
                  </div>
              ...
              <div className=' m-6'>
                ...
                <div className=' grid grid-cols-2 gap-x-4 h-auto' >
                  {data?.experience.length > 0 ? data?.experience.map((val) => {
                    return (<>

                      <div className='rounded-3xl border-9 h-auto bg-gray-100 mt-9 pl-5'>
              ...
              <form className="p-4 md:p-5" >
                ...
                <div className="grid gap-4 mb-4 ">
                  ...
                  <div className=" sm:col-span-1">
                    ...
                    <textarea required onChange={(e) => { setDuration(e.target.value) }} name="duration" id="duration" className="border border-gray-300 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 text-black dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Enter duration" />
                  </div>
                  <div className=" sm:col-span-1">
