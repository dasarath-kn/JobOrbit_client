        ...
        {plans && plans.length > 0 ? plans.map((val) => {
              ...
              <ul className="space-y-8 font-bold text-xl text-center mt-9 text-black">
                ...
                {subscribeduser?.plan_id._id === val._id && subscribeduser?.payment_status ? (
                  ...
                  <button
                    ...
                    className={`${!!subscribeduser?.plan_id._id ? 'bg-gray-300 text-gray-500' : 'bg-black text-white'
          ...
          >
            <div className="animate-pulse flex flex-col items-center space-y-8 mt-9 w-full h-full">
              <div className="h-10 bg-slate-200 rounded w-3/4 sm:w-2/3 lg:w-1/2"></div> 
              <div className="h-8 bg-slate-200 rounded w-1/2 sm:w-1/3 lg:w-1/4"></div> 
              <div className="h-8 bg-slate-200 rounded w-1/3 sm:w-1/4 lg:w-1/4"></div> 
              <div className="h-8 bg-slate-200 rounded w-2/3 sm:w-1/2 lg:w-1/3"></div> 
